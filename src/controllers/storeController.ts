...
import { uploadToCloudinary } from '../utils/cloudinary'; // Optional, if you are handling images for the store
...
export const createStore = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    return res.status(201).json({ store: newStore, message: 'Store created successfully' });
  } catch (error) {
...
export const getStores = async (_req: Request, res: Response): Promise<any> => {
  try {
    ...
    return res.status(200).json({ stores, message: 'Stores fetched successfully' });
  } catch (error) {
...
export const updateStore = async (req: Request, res: Response): Promise<any> => {
  try {
    ...
    return res.status(200).json({ store: updatedStore, message: 'Store updated successfully' });
  } catch (error) {
